...
console.log(error.msg)
  ...
  return (
    <main className={`pageContainer  ${poppins.className}`}>
       ...
       {loading === true ? <ThreeCirclesLoader /> :  <section  className="pageContent">
          <div className={styles.card}>
           ...
           {order !== null &&  <section className={styles.details}>
                ...
                <div className={styles.productsInfo}>
                  {order && order?.boughtItems?.map(product => {
                    ...
                    <h2 className={styles.detailInfo}>${
                      product?.item?.discountPercentage !== 0 ? (product?.item?.price - (product?.item?.price * (product?.item?.discountPercentage / 100))) : product?.item?.price
                    }</h2>
                ...
                <h2 className={styles.detailInfo}>${order?.subTotal}</h2>
                </div>
                <div className={styles.detailLine}>
                <h2 className={styles.detailLabel}>Shipping</h2>
                <h2 className={styles.detailInfo}>${order?.shipping}</h2>
                </div>
                <div className={styles.detailLine}>
                <h2 className={styles.detailLabel}>Total</h2>
                <h2 className={styles.detailInfo}>${order?.total}</h2>
                </div> 
            </section>}
            <p className={styles.parag}>
