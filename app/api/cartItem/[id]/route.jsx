...
export async function PATCH(request, {params}){
    ...
    if(!session){
        return new Response("You are not authorized to update cart items", {status: 401});
    }
...
export async function DELETE(request, {params}){
    ...
    if(!session){
        return new Response("You are not authorized to delete cart items", {status: 401});
    }
    ...
    try{
        ...
        return new Response("CartItem deleted", {status: 200});
    }
    catch(error){
        console.log(error)
        return new Response("Something went wrong", {status: 500});
